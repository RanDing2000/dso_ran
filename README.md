...
<p align="center">
<a href="https://arxiv.org/abs/2503.22677"><img src="https://img.shields.io/badge/arXiv-2503.22677-b31b1b" alt="arXiv"></a>
...
python evaluation/evaluate_geometry.py --mesh_paths "./samples/objaverse_samples/*.glb" --ground_truth_paths /data3/ran/dso/objaverse/hf-objaverse-v1/glbs
```
...
python -m data_preprocessing.generate_synthetic_data --num_samples 4 --save_extra --output_dir train_data/train_outputs --image_paths "/home/ran.ding/messy-kitchen/dso/image-to-3D-eval-stability-under-gravity/train_demo/*/*.jpg"


python -m data_preprocessing.generate_synthetic_data --num_samples 4 --save_extra --output_dir train_data/train_outputs --image_paths "/home/ran.ding/messy-kitchen/dso/image-to-3D-eval-stability-under-gravity/objaverse_demo/*/*.png"
```
...
python -m data_preprocessing.augment_with_simulation_feedback --root_dir train_data/train_outputs/train_demo --num_models_per_image 4

python -m data_preprocessing.augment_with_simulation_feedback --root_dir train_data/train_outputs/animals --num_models_per_image 4
```
