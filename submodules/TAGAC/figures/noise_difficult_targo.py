...
# Set font to Times using LaTeX rendering for better Times font support
plt.rcParams.update({
    'text.usetex': True,
    'font.family': 'serif',
    'font.serif': ['Times', 'Times New Roman', 'Arial'],
...
# Labels
plt.xlabel("Occlusion Level", fontsize=32)
...
plt.savefig("noise_targo_classes.png", bbox_inches="tight")
# plt.show()
