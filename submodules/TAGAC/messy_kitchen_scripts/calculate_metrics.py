        ...
        for pred_file in pred_files:
            try:
                ...
                if not mesh.is_watertight:
                    ...
                    # assert mesh.is_watertight, f"Predicted mesh {pred_file.name} is not watertight after fixing"
        ...
        for gt_file in gt_files:
            try:
                ...
                if not mesh.is_watertight:
                    ...
                    mesh.remove_infinite_values()
                    mesh.remove_unreferenced_vertices()
                    # assert mesh.is_watertight, f"GT mesh {gt_file.name} is not watertight after fixing"
