...
def main(args):
    ...
    for curr_mesh_pose_list in npz_files:
        ...
        scene_root = 'data_scenes/acronym/acronym-middle-occlusion-1000/scenes'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root",type=Path, default= 'data_scenes/acronym/acronym-middle-occlusion-1000')
