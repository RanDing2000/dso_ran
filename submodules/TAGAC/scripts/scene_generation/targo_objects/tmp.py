...
def process_npz_file_with_steps(npz_path, mesh_pose_path, model, preprocess, device, class_names, 
    ...
    try:
        ...
        # npz_path = PosixPath('data_scenes/targo_dataset/scenes/6776236d6eed443ebec7405633aadbdd_c_2.npz')
        scene_name = npz_path.stem  # '6776236d6eed443ebec7405633aadbdd_c_2'
        target_id = int(scene_name.split('_')[-1])  # '2'
        assert segmentation_map[target_id] == mask_targ
