...
def main(args):
    ...
    occ_level_sr = target_sample_offline_acronym.run(
        ...
        model_type='ptv3_scene',  # 确保模型类型一致
...
if __name__ == "__main__":
    ...
    if args.occlusion_level == "medium":
        ...
        if args.hunyuan3D_path is None:
            args.hunyuan3D_path = '/home/ran.ding/projects/Gen3DSR/hunyuan_results/acronym/medium'
        if args.result_root is None:
            args.result_root = 'targo_eval_results/acronym/eval_results_ptv3_scene-medium-occlusion'  
        if args.logdir is None:
            args.logdir = Path('targo_eval_results/acronym/eval_results_ptv3_scene-medium-occlusion')
        ...
        if args.hunyuan3D_path is None:
            args.hunyuan3D_path = '/home/ran.ding/projects/Gen3DSR/hunyuan_results/acronym/slight'
        if args.result_root is None:
            args.result_root = 'targo_eval_results/acronym/eval_results_ptv3_scene-slight-occlusion'
        if args.logdir is None:
            args.logdir = Path('targo_eval_results/acronym/eval_results_ptv3_scene-slight-occlusion')
        if args.test_root is None:
        ...
        if args.hunyuan3D_path is None:
            args.hunyuan3D_path = '/home/ran.ding/projects/Gen3DSR/hunyuan_results/acronym/no'
        if args.result_root is None:
            args.result_root = 'targo_eval_results/acronym/eval_results_ptv3_scene-no-occlusion'
        if args.logdir is None:
            args.logdir = Path('targo_eval_results/acronym/eval_results_ptv3_scene-no-occlusion')
        if args.test_root is None:
