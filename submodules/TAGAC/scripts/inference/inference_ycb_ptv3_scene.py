...
def main(args):
    ...
    print(f"\nStarting PTV3 Scene inference on {args.occlusion_level} occlusion YCB dataset...")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="PTV3 Scene Inference on YCB Dataset")
    ...
    if args.occlusion_level == "medium":
        ...
        if args.result_root is None:
            args.result_root = 'targo_eval_results/ycb/eval_results_ptv3_scene-medium-occlusion'
        if args.logdir is None:
            args.logdir = Path('targo_eval_results/ycb/eval_results_ptv3_scene-medium-occlusion')
        ...
        if args.result_root is None:
            args.result_root = 'targo_eval_results/ycb/eval_results_ptv3_scene-slight-occlusion'
        if args.logdir is None:
            args.logdir = Path('targo_eval_results/ycb/eval_results_ptv3_scene-slight-occlusion')
        if args.test_root is None:
        ...
        if args.result_root is None:
            args.result_root = 'targo_eval_results/ycb/eval_results_ptv3_scene-no-occlusion'
        if args.logdir is None:
            args.logdir = Path('targo_eval_results/ycb/eval_results_ptv3_scene-no-occlusion')
        if args.test_root is None:
