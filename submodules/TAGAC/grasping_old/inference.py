...
def create_and_write_args_to_result_path(args):
    ...
    if args.type == "afford_scene_targ_pc":
        if args.complete_target_ablation == "":
        ...
        elif args.complete_target_ablation == "complete_target":
            model_name = f'complete_target/{args.type}/{args.fusion_type}/sc_{args.shape_completion}/gt_shape_{args.complete_shape}_num_layer_{args.num_encoder_layers}'
        elif args.complete_target_ablation == "complete_scene":
            model_name = f'complete_scene/{args.type}/{args.fusion_type}/sc_{args.shape_completion}/gt_shape_{args.complete_shape}_num_layer_{args.num_encoder_layers}'
...
def main(args):
    ...
    if args.task_eval == 'target_driven_offline':
        occ_level_sr = target_sample_offline.run(
            ...
            shape_completion=args.shape_completion,
            complete_targ_ablation = args.complete_target_ablation,
            )
        ## write to file
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=Path, default='/usr/stud/dira/GraspInClutter/grasping/checkpoints_gaussian/baseline_comparisons/main_model.pt')
    ...
    parser.add_argument("--logdir", type=Path, default="/usr/stud/dira/GraspInClutter/grasping/data/eval_eccv")
    ...
    parser.add_argument("--test_root", type=str, default='/storage/user/dira/nips_data_version6/test_set_gaussian_0.002/', help= "clutter_removal | target_driven_online | target_driven_offline")
    ...
    parser.add_argument("--complete_target_ablation", type=str, default="", help = "complete_target | complete_scene | ")
