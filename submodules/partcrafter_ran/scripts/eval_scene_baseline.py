...
class PartCrafterEvaluator:
    def __init__(self, 
        ...
        # Download and load base model components - exactly match inference_partcrafter_scene.py
        ...
        # Download RMBG weights - exactly match inference_partcrafter_scene.py
        rmbg_weights_dir = "pretrained_weights/RMBG-1.4"
        snapshot_download(repo_id="briaai/RMBG-1.4", local_dir=rmbg_weights_dir)
        
        # init rmbg model for background removal - exactly match inference_partcrafter_scene.py
        ...
        # Set seed for reproducibility - same as inference_partcrafter_scene.py
        set_seed(0)
...
# import trimesh
    ...
    def run_inference(self, 
        ...
        """
        Run PartCrafter inference - exactly matching inference_partcrafter_scene.py run_triposg function
        
        Returns:
            generated_meshes: List of generated meshes
            processed_image: Processed input image
        """
        # Exactly match inference_partcrafter_scene.py run_triposg function
...
def main():
    ...
    parser.add_argument('--output_dir', type=str, 
                       default='./results/evaluation_objects_demo_test_100_baseline',
    ...
    # Handle "None" string for load_trained_checkpoint
    if args.load_trained_checkpoint == "None":
        args.load_trained_checkpoint = None
